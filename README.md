...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=20&pause=1000&color=58A6FF&center=true&vCenter=true&width=420&lines=%E2%86%92+AI%2FML;KG-RAG+%7C+PINNs+%7C+MLOps;Building+in+Unity+%26+RPG+Maker" alt="Typing SVG" />
...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/spacexplorer20-ship/spacexplorer20-ship/main/light_mode.svg">
  <img src="https://raw.githubusercontent.com/spacexplorer20-ship/spacexplorer20-ship/main/dark_mode.svg" alt="Stats card" width="100%">
</picture>

<sub>Auto-updates daily via <code>today.py</code> + GitHub Actions — see setup notes below.</sub>
...
<img src="src/assets/coding.gif" width="100%" alt="Coding animation" />
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,cpp,java,js,html,css,vue,react,flask,nodejs,docker,git,aws,gcp,mongodb&theme=dark" alt="Tech stack icons">
</p>

<p align="center">
  <kbd>
    <kbd>Research / ML</kbd><br><br>
    <a href="https://neo4j.com/" target="_blank"><img width="30px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/neo4j/neo4j-original.svg" /></a>
    <a href="https://pytorch.org/" target="_blank"><img width="30px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pytorch/pytorch-original.svg" /></a>
...
<details>
<summary>⚙️ Stats card setup (one-time)</summary>

The stats card is driven by <code>today.py</code> + <code>.github/workflows/readme-stats.yml</code> (runs daily at 04:00 UTC, plus on every push to <code>main</code>). To activate it on GitHub:

1. Create a fine-grained personal access token with **read** access to: Followers, Starring, Watching (account) and Commit statuses, Contents, Issues, Metadata, Pull Requests (repository, all repos).
