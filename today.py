...
USER_NAME = os.environ['USER_NAME'] # 'spacexplorer20-ship'
...
if __name__ == '__main__':
    """
    Adapted for spacexplorer20-ship, based on Andrew Grant's (Andrew6rant) original LOC-counter README script.
    Uses the account's GitHub creation date (instead of a birthday) to drive the "Member since" field, so no
    personal birthdate needs to be hardcoded here.
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate the account's creation date
